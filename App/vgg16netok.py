...
trainSet =LoadPartDataset(txt=root+'train_bin.txt')
test_data=LoadPartDataset(txt=root+'test_bin.txt')
test_infor=loadTestData(txt=root+'test_bin.txt')
...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc3 = nn.Linear(4096, labelnum)
        # softmax 1 * 1 * 1000
